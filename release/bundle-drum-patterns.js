...
`]}constructor(){super(),(0,a.makeObservable)(this)}onSoundChanged(){const e=this.currentSound;e&&(0,a.runInAction)((async()=>{await o.AudioEnvironment.instance.samplesFuture;const t=await o.AudioEnvironment.instance.locateSoundAsync(e);this.svgUrl=t.svgUrl,this.attributeStyleMap.set("--sample-image",`url('${this.svgUrl}')`)}))}render(){let e;return console.log((0,c.isMobile)()),this.moving&&(0,c.isMobile)()&&(e=i.html`<div class="moving-indicator"></div>`),i.html`
<div class="bg">
</div>
${e}
